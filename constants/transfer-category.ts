export const transferCategories = [
	...
	{ icon: 'credit-card-payment', label: 'Credit Card Payment' },
	{ icon: 'savings-contribution', label: 'Savings Contribution' },
	{ icon: 'received-from-family', label: 'Received from Family/Friends' },
